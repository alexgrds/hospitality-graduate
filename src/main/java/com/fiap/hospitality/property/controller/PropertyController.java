...
public class PropertyController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "SUCCESS - Consumption successfully saved", content = @Content(schema = @Schema(implementation = Property.class), mediaType = MediaType.APPLICATION_JSON_VALUE)),
    })
    @PostMapping
    public ResponseEntity<Property> save(@RequestBody @Valid PropertyRequest propertyRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Property> updateProperty(@PathVariable String id, @Valid @RequestBody PropertyRequest request) {
